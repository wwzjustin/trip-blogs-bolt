...
export default function AttractionModal({ attraction, onClose }: AttractionModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative h-64 md:h-80 bg-gray-200 flex-shrink-0">
          <img
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-6">
            <h2 className="text-3xl font-bold text-white mb-2">{attraction.nameCn}</h2>
            <p className="text-gray-200 text-lg">{attraction.nameEn}</p>
          </div>
        </div>
        ...
        <div className="overflow-y-auto flex-1 p-6 md:p-8">
          ...
          {attraction.historicalContext && (
            <div className="mb-6">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="text-xl font-bold text-gray-900">历史定位</h3>
              </div>
              <p className="text-gray-700 leading-relaxed">{attraction.historicalContext}</p>
            </div>
          )}
          ...
          {attraction.experience && (
            <div className="mb-6">
              <div className="flex items-center space-x-2 mb-3">
                <MapPin size={20} className="text-blue-900" />
                <h3 className="text-xl font-bold text-gray-900">实地体验</h3>
              </div>
              <p className="text-gray-700 leading-relaxed">{attraction.experience}</p>
            </div>
          )}
          ...
          {attraction.insight && (
            <div className="mb-6 bg-amber-50 border-l-4 border-amber-600 p-4 rounded-r-lg">
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">核心洞察</h3>
                  <p className="text-gray-800 leading-relaxed italic">{attraction.insight}</p>
                </div>
              </div>
            </div>
          )}
          ...
          {attraction.relatedPeople && attraction.relatedPeople.length > 0 && (
            <div>
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="text-xl font-bold text-gray-900">相关人物</h3>
              </div>
