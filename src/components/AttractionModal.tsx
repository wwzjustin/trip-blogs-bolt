...
export default function AttractionModal({ attraction, onClose }: AttractionModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-2 md:p-6 bg-[#2d3435]/60"
      style={{ backdropFilter: 'blur(4px)' }}
      onClick={onClose}
    >
      <div
        className="bg-white rounded-lg max-w-3xl w-full max-h-[95vh] md:max-h-[90vh] overflow-hidden flex flex-col"
        style={{ boxShadow: 'var(--shadow-lg)' }}
        onClick={(e) => e.stopPropagation()}
      >
        <div className="relative h-48 sm:h-56 md:h-72 bg-[#f2f4f4] flex-shrink-0">
          <img
